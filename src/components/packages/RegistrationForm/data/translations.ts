...
export const contactFormValues = {
  fr: {
    ...
    groupHours: {
      ...
      group3: "Horaires des cours : jeudi 19h00–20h15",
    },
  ...
  en: {
    ...
    groupHours: {
      ...
      group3: "Lesson hours: Thursday 19:00–20:15",
    },
  ...
  de: {
    ...
    groupHours: {
      ...
      group3: "Unterrichtszeiten: Donnerstag 19:00–20:15 Uhr",
    },
  ...
  it: {
    ...
    groupHours: {
      ...
      group3: "Orari delle lezioni: giovedì 19:00–20:15",
    },
  ...
  ge: {
    ...
    groupHours: {
      ...
      group3: "გაკვეთილების დრო: ხუთშაბათი 19:00–20:15",
    },
